                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900">{{ number_format($taxDeclaration->total_deductions, 0, ',', '.') }} VND</p>
                                <ul class="text-sm text-gray-600 ml-4">
                                    <li>Giảm trừ bản thân: {{ number_format($taxDeclaration->personal_deduction, 0, ',', '.') }} VND ({{ number_format($taxDeclaration->personal_deduction_rate, 0, ',', '.') }} VND/tháng)</li>
                                    <li>Giảm trừ người phụ thuộc: {{ number_format($taxDeclaration->dependent_deduction, 0, ',', '.') }} VND ({{ number_format($taxDeclaration->dependent_deduction_rate, 0, ',', '.') }} VND/người/tháng)</li>
