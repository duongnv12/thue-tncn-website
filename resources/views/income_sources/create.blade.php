                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('income_sources.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="amount" class="block mt-1 w-full" type="number" name="amount" :value="old('amount')" required min="0" step="any" />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="frequency" name="frequency" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" required>
                                ...
                                <option value="yearly" {{ old('frequency') == 'yearly' ? 'selected' : '' }}>Hàng năm (cần xử lý thủ công cho tháng)</option>
                                <option value="one-time" {{ old('frequency') == 'one-time' ? 'selected' : '' }}>Một lần (cần xử lý thủ công cho tháng)</option>
                            </select>
